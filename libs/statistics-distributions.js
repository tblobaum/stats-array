...
exports.chisqrdistr = function chisqrdistr ($n, $p) {
...
exports.udistr = function udistr ($p) {
  if ($p > 1 || $p <= 0) {
    throw("Invalid p: $p\n");
  }
...
exports.tdistr = function tdistr ($n, $p) {
  if ($n <= 0 || Math.abs($n) - Math.abs(integer($n)) != 0) {
    throw("Invalid n: $n\n");
  }
  if ($p <= 0 || $p >= 1) {
...
exports.fdistr = function fdistr ($n, $m, $p) {
  if (($n<=0) || ((Math.abs($n)-(Math.abs(integer($n))))!=0)) {
...
exports.uprob = function uprob ($x) {
  return precision_string(_subuprob($x-0));
}

exports.chisqrprob = function chisqrprob ($n,$x) {
  if (($n <= 0) || ((Math.abs($n) - (Math.abs(integer($n)))) != 0)) {
    throw("Invalid n: $n\n"); /* degree of freedom */
  }
...
exports.tprob = function tprob ($n, $x) {
  if (($n <= 0) || ((Math.abs($n) - Math.abs(integer($n))) !=0)) {
    throw("Invalid n: $n\n"); /* degree of freedom */
  }
...
exports.fprob = function fprob ($n, $m, $x) {
  if (($n<=0) || ((Math.abs($n)-(Math.abs(integer($n))))!=0)) {
    throw("Invalid n: $n\n"); /* first degree of freedom */
  }
  if (($m<=0) || ((Math.abs($m)-(Math.abs(integer($m))))!=0)) {
